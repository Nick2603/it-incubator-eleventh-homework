...
export class AuthController {
  ...
  async login(req: Request, res: Response) {
    ...
    await this.sessionsService.addSession(refreshToken, ip, deviceTitle, user.id.toString());
  ...
  async refreshToken(req: Request, res: Response) {
    ...
    const isRefreshTokenInSession = this.sessionsService.isRefreshTokenInSession(refreshTokenFromReq);
    ...
    const metadata = await this.jwtService.getRefreshTokenMetadata(refreshTokenFromReq);
    let deviceId: string = "";
  ...
  async newPassword(req: Request, res: Response) {
    ...
    const validCode = await this.recoveryCodesService.validateRecoveryCode(recoveryCode);
